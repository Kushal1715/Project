...
<div class="container mt-5">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <input type="text" value="<?php echo $product_title ?>" id="product_title" name="product_title" class="form-control mb-4" required="required">
        </div>
        <div class="form-outline w-50 m-auto ">
            <label for="product_desc" class="form-label">Product Description</label>
            <textarea rows="6" cols="50" id="product_desc" name="product_desc" class="form-control mb-4 h-50" required="required"><?php echo $product_description ?></textarea>
        </div>
        <div class="form-outline w-50 m-auto mb-4">
            <label for="product_keyword" class="form-label">Product Keywords</label>
            <input type="text" value="<?php echo $product_keyword ?>" id="product_keyword" name="product_keyword" class="form-control mb-4" required="required">
        </div>
        <div class="form-outline w-50 m-auto mb-4">
